...
public enum PartySize {
    ...
    /// Default party size
    public static let defaultSize = 2
    ...
    public static func increment(_ current: Int) -> Int {
    ...
    public static func decrement(_ current: Int) -> Int {
    ...
    public static func canDecrement(_ current: Int) -> Bool {
        current > minimum
    }
    ...
    public static func canIncrement(_ current: Int) -> Bool {
        current < maximum
    }
